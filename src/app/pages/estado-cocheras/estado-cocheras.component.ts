...
export class EstadoCocherasComponent {
  ...
  preguntarBorrarCochera(cocheraId: number) {
    Swal.fire({
      ...
      text: "Escribe el identificador de la cochera para confirmar:",
      input: 'text', // Especificar que deseas un campo de texto
      showCancelButton: true,
      ...
      inputValidator: (value) => {
        ...
        // Validar si el identificador de cochera ya existe
